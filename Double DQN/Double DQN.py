...
class Double_DQN:
    ...
    def replace_parameters(self):
        self.main_network.save_parameters('Double DQN temp params')
        self.target_network.load_parameters('Double DQN temp params')
        print('Double DQN parameters replaced')

    def save_parameters(self):
        self.target_network.save_parameters('Double DQN target network parameters')
        self.main_network.save_parameters('Double DQN main network parameters')

    #
    def load_parameters(self):
        self.target_network.load_parameters('Double DQN target network parameters')   # model path
        self.main_network.load_parameters('Double DQN main network parameters')
...
agent = Double_DQN(n_action=env.action_space.n,
...
for i_episode in range(100):
    ...
    while True:
        ...
        if done:
            print('Double DQN episode {} ends with success at time step {}'.format(i_episode, episode_steps))
